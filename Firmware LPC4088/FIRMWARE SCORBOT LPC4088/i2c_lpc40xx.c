...
void i2c_inicializar(LPC_I2C_TypeDef *i2c_regs, uint32_t frecuencia_scl,
	...
	ASSERT(i2c_regs == I2C0 || i2c_regs == I2C1 || i2c_regs == I2C2, "Numero de interfaz I2C incorrecto.");
    
	sclh_mas_scll = PeripheralClock/frecuencia_scl;
	ASSERT(sclh_mas_scll >= 8, "No se puede ajustar la frecuencia I2C solicitada.");
